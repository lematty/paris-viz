...
export const INFO: Record<VizKey, Record<Lang, VizInfoContent>> = {
  ...
  logis: {
    en: {
      ...
      sources: [
        {
          label: "SDES, RPLS (licence ouverte)",
          href: "https://www.data.gouv.fr/datasets/donnees-detaillees-au-logement-du-repertoire-des-logements-locatifs-des-bailleurs-sociaux-rpls",
        },
      ],
    },
    fr: {
